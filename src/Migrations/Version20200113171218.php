 ...
 */
final class Version20200113171218 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE orders (id INT AUTO_INCREMENT NOT NULL, userid INT DEFAULT NULL, amount INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, adress VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, phone VARCHAR(20) DEFAULT NULL, shipinfo VARCHAR(255) DEFAULT NULL, status VARCHAR(20) DEFAULT NULL, note VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, created_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE shopcart CHANGE userid userid INT DEFAULT NULL, CHANGE siparisid siparisid INT DEFAULT NULL, CHANGE quantity quantity INT DEFAULT NULL');
    }
